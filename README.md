...
- Post creation
- Post interactions (like and comment)
...
In order to run this project you should have the following installed:
- Ruby environment 
- Postgres database
...
```sh
cd my-folder
git clone https://github.com/Adams-Ghub/blog-app.git
```
...
I would like to thank Microverse for conceptualizing this project and also providing reviewers to ensure the good quality of the code base.
